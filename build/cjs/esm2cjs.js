...
async function esm2cjs({ inDir, outDir, globs = ["**/*.js"], sourcemap = true, logLevel = "warning", platform = "node", target = "node18", cleanOutDir = false, writePackageJson = true, packageJsonSideEffects }) {
  if (cleanOutDir)
  ...
  if (writePackageJson) {
    const sideEffects = (
      ...
      packageJsonSideEffects === true || packageJsonSideEffects === void 0 ? {} : { sideEffects: packageJsonSideEffects }
    );
